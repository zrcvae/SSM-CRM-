...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="09add196ecf64aed903f680f8b07c8c3">
				<input type="text" class="form-control" id="create-activityName" value="测试1">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="9ffc7f160492445393a5a6033e905c5e">
